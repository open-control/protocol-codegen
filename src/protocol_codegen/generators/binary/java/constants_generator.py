"""
Java Constants Generator for Binary Protocol
Generates ProtocolConstants.java from BinaryConfig.
...
class ProtocolConfig(TypedDict, total=False):
    """Protocol configuration structure for Binary."""
...
def generate_constants_java(
    ...
    """
    Generate ProtocolConstants.java for Binary protocol.
