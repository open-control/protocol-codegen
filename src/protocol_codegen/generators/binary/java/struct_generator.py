...
from protocol_codegen.generators.binary.java.logger_generator import generate_log_method
...
def _get_encoded_size(type_name: str, raw_size: int) -> int:
    ...
    For Binary protocol, there is no expansion - raw sizes are preserved.
